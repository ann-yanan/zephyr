...
#undef CUSTOM_INIT_THREAD_MSTATUS
	/* FIXME: vxsat、vxrm controled by FS on 0.7.1 version */
...
/*
 * FIXME: Due to early development reasons, when it was ported from within,
 * FIXME: __start was implemented separately as __xuntie_start,
 * FIXME: which conflicts with zephyr's __start.
 * FIXME: This is temporary and the conflict will be resolved later.
 *
 * riscv_soc_init_cpu
 */
